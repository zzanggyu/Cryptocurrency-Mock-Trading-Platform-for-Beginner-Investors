...
import OrderForm from './TOTAL-example/trading/OrderForm';
import PendingOrders from './TOTAL-example/trading/PendingOrders';
import TransactionHistory from './TOTAL-example/trading/TransactionHistory';
import CoinInfo from './components/news/CoinInfo';
